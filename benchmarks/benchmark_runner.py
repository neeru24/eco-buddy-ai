...
SUITES = [EmissionsBenchmark, OcrBenchmark, ReportBenchmark, DatabaseBenchmark, PerformanceLatencyBenchmark]
...
def main(argv=None):
    ...
    for cls in SUITES:
        ...
        print(f"   {'[OK]' if 'error' not in r else '[FAIL]'}  {n} benchmark(s)")
