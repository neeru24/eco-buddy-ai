...
class BaselineAnalyzer:
    ...
    def establish_baseline(self, 
        ...
        baseline.overall_efficiency = statistics.mean([
        ...
        # Member breakdown (if member data available)
    ...
    def get_baseline_summary(self, 
        ...
        return {
            ...
            'efficiency_grade': self._get_efficiency_grade(analysis.overall_efficiency),
